...
/*************************************************
	...
	**************************************************/
		...
		/********* obtain the fid's to display ***********************/
			...
			foreach($corrected_keys as $row){
				$records= (new File_keys())->get_fid_by_key(base64_encode($row));
				foreach($records as $row1){
					$fid_arr[$i++]=$row1->f_id;
				}
			}
